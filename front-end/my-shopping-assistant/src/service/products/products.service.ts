...
export const getProductsByCollectionId = async ( collectionId: string, filter?: string, sorter?: string ) => {
    return api.get(`/collections/${collectionId}/product`, { params: { elementsPerPage: 99999, page: 0, filter, sorter }}).then( res => res.data );
}
